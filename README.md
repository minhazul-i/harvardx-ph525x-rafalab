...
For learning the statistical background and getting used to implementing them using R, I found this book by one of my favorite statisticians **Danille Navarro** the most helpful:
